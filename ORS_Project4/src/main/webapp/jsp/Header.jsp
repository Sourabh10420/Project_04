...
<table >
    <tr ><th></th>
       <td width="90%" >
        ...
        <a href="<%=ORSView.WELCOME_CTL%>"><b style="color:maroon;">Welcome</b></a> |
      
            	<%
            		if (userLoggedIn) {
      		 	 %> 
       <a href=" <%=ORSView.LOGIN_CTL%>?operation=<%=LoginCtl.OP_LOG_OUT%>"><b style="color: maroon;">Logout</b></a>

            <%
                } else {
            %> 
            <a href="<%=ORSView.LOGIN_CTL%>"><b style="color: maroon;">Login</b></a> 
            <%
  			   }
			 %>
